...
> **AI Agent Skills**: Shared agents are in `.github/agents/` (rl-agents-n-skills submodule). Scan for relevant skill files at session start. See `.github/agents/CLAUDE.md` for the full agent index.
