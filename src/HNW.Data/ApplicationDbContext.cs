...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ReferenceLink>().HasData(
            ...
            new ReferenceLink { Id = new Guid("11111111-1111-1111-1111-111111111104"), Category = ReferenceLinkCategory.OpenShiftNetworking, SortOrder = 40, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "BC Gov Private Cloud \u2014 Network Policies", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/openshift-network-policies/", Description = "Platform-specific NetworkPolicy guidance for BC Gov OpenShift namespaces." },
            ...
            // ── Cluster Tiers ─────────────────────────────────────────────────
            new ReferenceLink { Id = new Guid("22222222-2222-2222-2222-222222222201"), Category = ReferenceLinkCategory.ClusterTiers, SortOrder = 10, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "BC Gov Private Cloud Clusters", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/hosting-tiers-table/", Description = "Comparison of Silver, Gold, and Emerald cluster capabilities, SDN implementations, and networking differences." },
            new ReferenceLink { Id = new Guid("22222222-2222-2222-2222-222222222202"), Category = ReferenceLinkCategory.ClusterTiers, SortOrder = 20, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "Silver Cluster Networking Notes", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/hosting-tiers-table/#silver", Description = "Silver-specific networking: OpenShift SDN, HAProxy router, ingress/egress defaults." },
            new ReferenceLink { Id = new Guid("22222222-2222-2222-2222-222222222203"), Category = ReferenceLinkCategory.ClusterTiers, SortOrder = 30, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "Gold Cluster Networking Notes", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/hosting-tiers-table/#gold", Description = "Gold-specific networking: OVN-Kubernetes, default-deny stance, multi-zone topology." },
            new ReferenceLink { Id = new Guid("22222222-2222-2222-2222-222222222204"), Category = ReferenceLinkCategory.ClusterTiers, SortOrder = 40, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "Emerald Cluster Networking Notes", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/hosting-tiers-table/#emerald", Description = "Emerald-specific networking: strict default-deny ingress AND egress, AVI load balancer, DataClass enforcement." },
            new ReferenceLink { Id = new Guid("22222222-2222-2222-2222-222222222205"), Category = ReferenceLinkCategory.ClusterTiers, SortOrder = 50, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "AVI / NSX Advanced Load Balancer (Emerald)", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/hosting-tiers-table/#emerald", Description = "AVI replaces HAProxy on Emerald. Routes must carry the correct AVI InfraSettings annotation." },
            // ── DataClass & Network Zones ──────────────────────────────────────
            new ReferenceLink { Id = new Guid("33333333-3333-3333-3333-333333333301"), Category = ReferenceLinkCategory.DataClassAndZones, SortOrder = 10, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "BC Gov DataClass Overview", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/hosting-tiers-table/", Description = "How BC Government classifies data (Low / Medium / High) and what each class means for network access." },
            new ReferenceLink { Id = new Guid("33333333-3333-3333-3333-333333333302"), Category = ReferenceLinkCategory.DataClassAndZones, SortOrder = 20, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "Network Zone Model (Public / Private / Restricted)", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/platform-network-topology/", Description = "The three network zones and which data classes are permitted in each." },
            new ReferenceLink { Id = new Guid("33333333-3333-3333-3333-333333333303"), Category = ReferenceLinkCategory.DataClassAndZones, SortOrder = 30, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "DataClass Labels on Pods and Routes", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/hosting-tiers-table/#emerald", Description = "Required pod label DataClass: Medium and how it interacts with Emerald's AVI InfraSettings." },
            new ReferenceLink { Id = new Guid("33333333-3333-3333-3333-333333333304"), Category = ReferenceLinkCategory.DataClassAndZones, SortOrder = 40, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "Impact of DataClass on Egress (Emerald)", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/hosting-tiers-table/#emerald", Description = "How DataClass labelling determines which egress network zones your pods can reach on Emerald." },
            new ReferenceLink { Id = new Guid("33333333-3333-3333-3333-333333333305"), Category = ReferenceLinkCategory.DataClassAndZones, SortOrder = 50, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "AVI InfraSettings \u2014 dataclass-medium vs dataclass-low", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/hosting-tiers-table/#emerald", Description = "Only dataclass-medium has a registered VIP on Emerald. Never use dataclass-low." },
            ...
            new ReferenceLink { Id = new Guid("44444444-4444-4444-4444-444444444401"), Category = ReferenceLinkCategory.NetworkPolicyPatterns, SortOrder = 10, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "Two-policy rule: ingress + egress", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/openshift-network-policies/", Description = "Every network flow requires TWO policies: ingress on the receiver AND egress on the sender." },
            new ReferenceLink { Id = new Guid("44444444-4444-4444-4444-444444444402"), Category = ReferenceLinkCategory.NetworkPolicyPatterns, SortOrder = 20, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "DNS egress policy (UDP+TCP 53)", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/openshift-network-policies/", Description = "All pods need an explicit DNS egress policy (UDP 53 + TCP 53) on Emerald \u2014 not included by default." },
            new ReferenceLink { Id = new Guid("44444444-4444-4444-4444-444444444403"), Category = ReferenceLinkCategory.NetworkPolicyPatterns, SortOrder = 30, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "Allow egress to external IP / CIDR", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/openshift-network-policies/", Description = "How to write a CIDR-based egress policy to allow traffic to external systems or on-prem networks." },
            ...
            new ReferenceLink { Id = new Guid("44444444-4444-4444-4444-444444444405"), Category = ReferenceLinkCategory.NetworkPolicyPatterns, SortOrder = 50, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "Common port reference (Oracle 1521, MSSQL 1433, PG 5432, MySQL 3306)", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/openshift-network-policies/", Description = "Standard database and service ports used when writing egress NetworkPolicy rules." },
            new ReferenceLink { Id = new Guid("44444444-4444-4444-4444-444444444406"), Category = ReferenceLinkCategory.NetworkPolicyPatterns, SortOrder = 60, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "Third Party Gateway (3PG) / ExtraNet \u2014 external partner connectivity", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/openshift-network-policies/", Description = "Connections to external government partners (other ministries, Crown corps, health authorities) must traverse the ExtraNet zone via a Third Party Gateway (3PG). Requires formal approval and a dedicated egress NetworkPolicy rule targeting the 3PG CIDR." },
            // ── SDN Guidance ──────────────────────────────────────────────────
            new ReferenceLink { Id = new Guid("55555555-5555-5555-5555-555555555501"), Category = ReferenceLinkCategory.SdnGuidance, SortOrder = 10, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "Default-deny ingress and egress on Emerald", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/openshift-network-policies/#default-policy", Description = "Emerald enforces default-deny on BOTH ingress and egress. Every flow must be explicitly allowed." },
            ...
            new ReferenceLink { Id = new Guid("55555555-5555-5555-5555-555555555505"), Category = ReferenceLinkCategory.SdnGuidance, SortOrder = 50, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "SDN Security Classification \u2014 Low / Medium / High workload model", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/hosting-tiers-table/", Description = "2022 BC Gov SDN model: Low = public info (DMZ-equivalent, internet accessible), Medium = Protected A (Zone B-equivalent, no direct internet), High = Protected B-C (Zone A-equivalent, internet blocked at guardrail). DataClass pod label must match workload classification." },
            new ReferenceLink { Id = new Guid("55555555-5555-5555-5555-555555555506"), Category = ReferenceLinkCategory.SdnGuidance, SortOrder = 60, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "Medium/High workloads \u2014 internet egress via Forward Proxy only", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/openshift-network-policies/", Description = "Medium security workloads cannot reach the internet directly \u2014 must use the SSBC SDN Forward Proxy (HTTP/HTTPS only). High security workloads require Ministry ISO (MISO) exemption for any internet access. Direct internet egress from Medium/High is denied at the guardrail." },
            new ReferenceLink { Id = new Guid("55555555-5555-5555-5555-555555555507"), Category = ReferenceLinkCategory.SdnGuidance, SortOrder = 70, IsActive = true, IsEnvironmentRelative = false, CreatedAt = seedDate, Title = "Zone adjacency rule \u2014 no zone hopping", Url = "https://developer.gov.bc.ca/docs/default/component/platform-developer-docs/docs/platform-architecture-reference/platform-network-topology/", Description = "BC Gov zone adjacency rule: communication is only permitted between adjacent zones. Traffic path: Internet \u2192 DMZ/Low \u2192 Medium \u2192 High. A session cannot be initiated directly from the internet into Medium or High zones. NetworkPolicy cannot bypass this adjacent-zones requirement." }
        );
    }
